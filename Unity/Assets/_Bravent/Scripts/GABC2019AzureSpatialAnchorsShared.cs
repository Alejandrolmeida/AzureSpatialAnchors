...
{
    public class GABC2019AzureSpatialAnchorsShared : DemoScriptBase
    {
        ...
        private readonly Dictionary<AppState, DemoStepParams> stateParams = new Dictionary<AppState, DemoStepParams>
    {
        ...
        public override void Update()
        {
            ...
            {
                counter = 0;
                // finding spatial anchors
                if (currentAppState != AppState.DemoStepLookingForAnchor)
                    AdvanceLocateFlowDemoSlimer();
            }
        ...
        private async void AdvanceLocateFlowDemoSlimer()
        {
#if !UNITY_EDITOR
